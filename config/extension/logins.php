                    ...
                    if($check == TRUE){
                        if(self::compilar()){
                            if(password_verify($compilar['contra'],(string) $compilar['encriptacion']) == TRUE){
                                ...
                                actualizar_datos_mysqli("table_users","`last_ip` = '$ip'","id",$compilar['id']);
                        ...
                        insertar_datos_clasic_mysqli("table_check_users","id_user, url, accion, expiracion","$id,'$key', 'check_user','$fecha_1_day'");
